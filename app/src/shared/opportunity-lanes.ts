...
export const OPPORTUNITY_LANES: OpportunityLane[] = [
  ...
  },
  {
    ...
    description: "State procurement opportunities across DemandStar and SLED portals",
    source: "demandstar",
    marketTier: "state",
    phase: 3,
  },
  {
    ...
    description: "Municipal and local government procurement portals",
    source: "bonfire",
    marketTier: "local",
    phase: 3,
  },
  ...
  },
  {
    ...
    description: "OhioBuys state procurement listings",
    source: "ohio",
    marketTier: "state",
    phase: 3,
  },
  {
    ...
    description: "Georgia Procurement Registry open events",
    source: "georgia",
    marketTier: "state",
    phase: 3,
  },
